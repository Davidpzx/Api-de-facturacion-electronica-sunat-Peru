...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('credit_notes', function (Blueprint $table) {
            ...
            $table->string('tipo_documento', 2)->default('07'); // 07: Nota de Crédito
            $table->string('serie', 4);
            $table->string('correlativo', 8);
            $table->string('numero_completo', 15); // Serie-Correlativo (FC01-000001)

            // Documento afectado (catálogo 09 / 10 SUNAT)
            $table->string('tipo_doc_afectado', 2); // 01: Factura, 03: Boleta
            $table->string('num_doc_afectado', 20); // Serie-Correlativo del comprobante afectado
            $table->string('cod_motivo', 2); // Catálogo 09: 01=Anulación operación, 07=Devolución por ítem, etc.
            $table->string('des_motivo', 250);
            ...
            // Forma de pago
            $table->string('forma_pago_tipo', 20)->default('Contado');
            $table->json('forma_pago_cuotas')->nullable();
